...
import com.github.solf.extra2.testutil.RevivableInputStream;
import com.github.solf.extra2.testutil.RevivableOutputStream;
...
public class TestRevivableInputStream
{
	...
	public void testQueueExceptionDuringRead() throws Exception
	{
		TestUtil.runWithTimeLimit(5000, () -> {
			...
			Pair<RevivableInputStream, RevivableOutputStream> pipe = TestUtil.createKillableBytePipe(100);
	...
	public void testExceptionDecoration() throws Exception
	{
		TestUtil.runWithTimeLimit(5000, () -> {
			...
			Pair<RevivableInputStream, RevivableOutputStream> pipe = TestUtil.createKillableBytePipe(4);
			try (RevivableInputStream stream = pipe.getValue0())
			{
