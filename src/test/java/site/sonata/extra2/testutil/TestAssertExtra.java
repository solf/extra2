...
import static site.sonata.extra2.testutil.AssertExtra.assertBetweenExclusive;
import static site.sonata.extra2.testutil.AssertExtra.assertBetweenInclusive;
import static site.sonata.extra2.testutil.AssertExtra.assertContains;
import static site.sonata.extra2.testutil.AssertExtra.assertContainsIgnoreCase;
import static site.sonata.extra2.testutil.AssertExtra.assertContainsWithFlag;
import static site.sonata.extra2.testutil.AssertExtra.assertContainsWithFlagIgnoreCase;
import static site.sonata.extra2.testutil.AssertExtra.assertFails;
import static site.sonata.extra2.testutil.AssertExtra.assertFailsWithSubstring;
import static site.sonata.extra2.testutil.AssertExtra.assertFailsWithSubstringIgnoreCase;
import static site.sonata.extra2.testutil.AssertExtra.assertGreater;
import static site.sonata.extra2.testutil.AssertExtra.assertGreaterOrEqual;
import static site.sonata.extra2.testutil.AssertExtra.assertLess;
import static site.sonata.extra2.testutil.AssertExtra.assertLessOrEqual;
import static site.sonata.extra2.testutil.AssertExtra.assertNotBetweenExclusive;
import static site.sonata.extra2.testutil.AssertExtra.assertNotBetweenInclusive;
import static site.sonata.extra2.testutil.AssertExtra.assertNotContains;
import static site.sonata.extra2.testutil.AssertExtra.assertNotContainsIgnoreCase;
