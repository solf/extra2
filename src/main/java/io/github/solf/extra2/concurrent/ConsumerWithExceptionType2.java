...
/**
 * {@link Consumer} that is allowed to throw TWO different specific {@link Exception} type
...
public interface ConsumerWithExceptionType2<T, E extends Exception, E2 extends Exception>
{
	/**
