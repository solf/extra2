...
/**
 * {@link Supplier} that is allowed to throw specific {@link Exception} type
...
public interface SupplierWithExceptionType<T, E extends Exception>
{
	/**
	 * Just like {@link Supplier#get()} but allows to throw specific exception.
	 */
