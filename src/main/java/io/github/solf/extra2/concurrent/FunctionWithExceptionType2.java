...
/**
 * {@link Function} that is allowed to throw TWO different specific {@link Exception} type
...
public interface FunctionWithExceptionType2<T, R, E extends Exception, E2 extends Exception>
{
    /**
