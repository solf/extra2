...
import com.github.solf.extra2.concurrent.exception.WATimeoutException;
import com.github.solf.extra2.exception.AssertionException;
...
public class MockSocketService
{
	...
	{
		MockSocketData mockSocketData = TestUtil.createMockSocket(bufferSize);
